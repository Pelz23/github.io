...
This project involved developing an interactive Sales Performance Dashboard to analyse key business metrics across revenue, profit, quantity sold, customer distribution, product categories, and regional performance. Using Power BI, the dataset was cleaned, transformed, and modelled to create a reliable analytical foundation. The dashboard visualises high‑level KPIs, monthly revenue trends, customer segmentation, and profitability across multiple product categories. It also highlights performance variations across global market regions and order regions, enabling a deeper understanding of where the business generates the most value.

The purpose of the project was to provide a data‑driven view of business performance, identify growth opportunities, and support strategic decision‑making. By combining DAX measures, interactive visuals, and intuitive design, the dashboard allows stakeholders to quickly assess trends, compare regions, evaluate product profitability, and understand customer behaviour. Overall, the project demonstrates strong analytical capability, effective use of Power BI features, and the ability to translate raw data into actionable business insights.
